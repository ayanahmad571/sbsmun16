...
if ($comsqlres->num_rows > 0) {
    ...
    while($comsqlrw = $comsqlres->fetch_assoc()) {
		...
		echo '
<!-- com item start -->
	<div style="border:1px bold black;" class="col-md-4 col-sm-6">
		...
		<div class="row">
			<div class="col-sm-12"> 
			<button onClick="window.location=\''.$comsqlrw['com_background_guide_src'].'\'" role="button" class="btn btn-primary">Background Guide</button>
			</div>
		</div>';
		}
