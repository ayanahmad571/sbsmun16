...
body {margin:0px; padding:0px; font-size:14px; line-height:24px; height:100%; width:100%; font-family: 'Lato'; color:#222; background-color: #fff; font-weight: 300; font-style: normal;  -webkit-user-select: none; -moz-user-select: none; -khtml-user-select: none; -ms-user-select: none; }
...
img {max-width: 100%;}
h1, h2, h3, h4, h5, h6{margin:0px; padding:0px; margin-bottom:15px; line-height:170%; text-transform:uppercase; letter-spacing:3px;}
h1{font-size:40px;}
h2{font-size:32px;}
h3{font-size:24px;}
h4{font-size:19px;}
...
header{width:100%; position:fixed; left:0; right:0; top:0; background:rgba(255,255,255,0.85);  z-index:999; height:60px; }
...
.nav-menu-icon a i {position: relative;display: inline-block;width: 24px;height: 3px;color:#222; text-indent:-55px;background: #222; transition:all .2s ease-out;-webkit-transition:all .2s ease-out;-moz-transition:all .2s ease-out;-ms-transition:all .2s ease-out;}
...
nav ul li a {color: #222; padding:22px 0; display:inline-block;}
...
.inner-banner-container{width:100%; height:550px; background: url(include/images/banner4.jpg) no-repeat center top; background-size:cover; background-attachment:fixed; position:relative;padding-top:60px;  }
...
.banner-title {position: relative; left: 50%; top: 50%;  transform: translateX(-50%) translateY(-50%);-webkit-transform: translateX(-50%) translateY(-50%);-moz-transform: translateX(-50%) translateY(-50%);-ms-transform: translateX(-50%) translateY(-50%); background: rgba(255,255,255,0.85); padding: 80px 50px; text-align: center; outline: 1px solid #fff; outline-offset: 8px; text-transform:uppercase; width:90%; max-width:600px;}
.banner-title h1 {font-size:40px; line-height:40px; margin:0; letter-spacing: 5px; }
.banner-title h2 {font-size:18px; line-height:30px; margin:0; margin-top:20px;  letter-spacing: 5px;}
...
footer{background:#222 url(include/images/black-bg.png) repeat left top; color:#999; font-size:13px; line-height:21px;}
...
.pagination > .active > a, .pagination > .active > span, .pagination > .active > a:hover, .pagination > .active > span:hover, .pagination > .active > a:focus, .pagination > .active > span:focus {z-index: 2; color: #fff; cursor: default; background-color: #222; border-color: #222;}
/* ============BLOG PAGE END================= */
...
.nav-tabs > li.active > a, .nav-tabs > li.active > a:hover, .nav-tabs > li.active > a:focus {color: #fff; cursor: default; background-color: #222; border: 1px solid #222; border-bottom-color: transparent;}
/*TOOLTIP*/
...
nav {position: fixed; width: 100%; height: 100%; padding-top: 60px; background: #fff; background:rgba(255,255,255,0.95); left: 0px; top: 0px; z-index: 500; text-align: left; overflow-y: auto; transform: translateY(-100%);-webkit-transform: translateY(-100%);-moz-transform: translateY(-100%);-ms-transform: translateY(-100%);}
...
.banner-title h2{font-size:14px; margin-top:5px;}
