...
<link rel="stylesheet" type="text/css" href="http://www.sbs-school.org/sbsweb/script/dtp/css/datepicker.css">    
<link rel="stylesheet" type="text/css" href="http://www.sbs-school.org/sbsweb/script/sf/bootstrap/bootstrap.min.css">           



<script src="http://www.sbs-school.org/sbsweb/script/clone/js/jquery.min.js"></script>
<script type="text/javascript"  src="include/forms/clone-form-td.js"></script>

        
    <link rel="stylesheet" type="text/css"  href="http://www.sbs-school.org/sbsweb/script/sf/css/smart-forms.css">
    <link rel="stylesheet" type="text/css"  href="http://www.sbs-school.org/sbsweb/script/sf/css/font-awesome.min.css">
    
    

	<link rel="stylesheet" type="text/css" href="http://www.sbs-school.org/sbsweb/script/sf/bootstrap/bootstrap.min.css">           
    <link rel="stylesheet" type="text/css" media="screen" href="http://www.sbs-school.org/sbsweb/script/dtp/css/bootstrap-datetimepicker.min.css" />
...
<link href="include/fa/css/font-awesome.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="http://www.sbs-school.org/sbsweb/script/sf/js/jquery.validate.js"></script>
    <script type="text/javascript" src="http://www.sbs-school.org/sbsweb/script/sf/js/additional-methods.js"></script>
...
<h4><i class="fa fa-pencil-square"></i>Delegate Registration Form</h4>
...
<div class="myspacer">
<div class="mytagline"><span>School Information</span></div>
<!-- .tagline -->
</div>
...
<div class="section colm colm3">          
 <div class="field-label">Alternate Mobile Number</div>
<label for="mobile_no" class="field prepend-icon">
<input name="mobile_no" class="gui-input" placeholder="Mobile No." type="text" id="mobile_no"/>
<b class="tooltip tip-right-top"><em>Please enter mobile no.</em></b>
<label for="mobile_no" class="field-icon"><i class="fa fa-mobile"></i></label>
...
<div class="field-label">Institution's Address </div>
...
<b class="tooltip tip-right-top"><em>Please enter Institution's address.</em></b>
...
<div class="myspacer">
<div class="mytagline"><span>MUN Faculty Advisor(s)</span></div>
<!-- .tagline -->
</div>          
...
<div id="dependants_entry1" class="clonedInput1">
...
<div class="section colm colm3">          
<label for="dependants_mobile_no" class="field prepend-icon">
<input name="dependants_mobile_no" class="dependants_name gui-input" placeholder="Mobile No." type="text" id="mobile_no"/>
<b class="tooltip tip-right-top"><em>Please enter mobile no.</em></b>
<label for="dependants_mobile_no" class="field-icon"><i class="fa fa-mobile"></i></label>
</label>
</div>


<div class="section colm colm4">          
<label for="dependants_email_id" class="field prepend-icon">
<input name="dependants_email_id" class="dependants_name gui-input" placeholder="Email" type="text" id="email_id" />
<b class="tooltip tip-right-top"><em>Please enter email.</em></b>
   <label for="dependants_email_id" class="field-icon"><i class="fa fa-envelope-o"></i></label>
</label>
</div> 
...
<div class="myspacer">
<div class="mytagline"><span>MUN Student Coordinator(s)</span></div>
<!-- .tagline -->
</div>
...
<div id="dependants_entry21" class="clonedInput2">

<div class="frm-row">


<div class="section colm colm1">          
<input type="button"  id="adependantrowno" class="dependantrowno gui-input" value="1" />
</div>


<div class="section colm colm4">          
<label for="dependants_munstucoord_name" class="field prepend-icon">
<input type="text"  name="dependants_munstucoord_name" id="dependants_munstucoord_name" class="dependants_name gui-input" placeholder="Name" />
<b class="tooltip tip-right-top"><em>Please enter name.</em></b>
 <label for="dependants_munstucoord_name" class="field-icon"><i class="fa fa-user"></i></label>
</label>
</div> 

<div class="section colm colm3">          
<label for="dependants_mobile_no_mo" class="field prepend-icon">
<input name="dependants_mobile_no_mo" class="dependants_name gui-input" placeholder="Mobile No." type="text" id="dependants_mobile_no_mo"/>
<b class="tooltip tip-right-top"><em>Please enter mobile no.</em></b>
<label for="dependants_mobile_no_mo" class="field-icon"><i class="fa fa-mobile"></i></label>
</label>
</div>


<div class="section colm colm4">          
<label for="dependants_email_id_id" class="field prepend-icon">
<input name="dependants_email_id_id" class="dependants_name gui-input" placeholder="Email" type="text" id="dependants_email_id_id" />
<b class="tooltip tip-right-top"><em>Please enter email.</em></b>
   <label for="dependants_email_id_id" class="field-icon"><i class="fa fa-envelope-o"></i></label>
</label>
</div> 
...
<div class="myspacer">
<div class="mytagline"><span>Expected Delegation Strength:</span></div>
<!-- .tagline -->
</div> 
...
<div class="myspacer1">
<div class="mytagline1"><span style="text-align:center"><br>
...
concerned schools will be notified via the contact details provided.<br><br>


Please enter your selections in order of preference. The country matrix given on the website

shall be used as reference.</span></div>
<!-- .tagline -->
</div>
<br>
<br><br>
...
<div class="field-label">Country Preference</div>
</div>
...
<script src="http://www.sbs-school.org/sbsweb/script/dtp/js/moment.js"></script>
<script src="http://www.sbs-school.org/sbsweb/script/dtp/js/bootstrap-datetimepicker.js"></script>
