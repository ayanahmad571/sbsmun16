...
$(function () {
    ...
    */
        ...
        newElem.find('.collage_name_address').attr('for', 'collage_name_address' + newNum);
        newElem.find('.collage_name_address').attr('id', 'collage_name_address' + newNum).attr('name', 'collage_name_address' + newNum).val('');


        // collage1 - text
        newElem.find('.board_university').attr('for', 'board_university' + newNum);
        newElem.find('.board_university').attr('id', 'board_university' + newNum).attr('name', 'board_university' + newNum).val('');

        // board - text
        newElem.find('.year_of_entering').attr('for', 'year_of_entering' + newNum);
        newElem.find('.year_of_entering').attr('id', 'year_of_entering' + newNum).attr('name', 'year_of_entering' + newNum).val('');
		
        // year_enter - text
        newElem.find('.year_of_passing').attr('for', 'year_of_passing' + newNum);
        newElem.find('.year_of_passing').attr('id', 'year_of_passing' + newNum).attr('name', 'year_of_passing' + newNum).val('');
		
		// year_passing - text
        newElem.find('.degree_diploma').attr('for', 'degree_diploma' + newNum);
        newElem.find('.degree_diploma').attr('id', 'degree_diploma' + newNum).attr('name', 'degree_diploma' + newNum).val('');
		
		
		// subjects1 - text
        newElem.find('.subjects').attr('for', 'subjects' + newNum);
        newElem.find('.subjects').attr('id', 'subjects' + newNum).attr('name', 'subjects' + newNum).val('');
		
		
		// marks1 - text
        newElem.find('.marks').attr('for', 'marks' + newNum);
        newElem.find('.marks').attr('id', 'marks' + newNum).attr('name', 'marks' + newNum).val('');
		
		
		
		// division1 - text
        newElem.find('.division').attr('for', 'division' + newNum);
        newElem.find('.division').attr('id', 'division' + newNum).attr('name', 'division' + newNum).val('');
