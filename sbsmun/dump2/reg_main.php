        	...
        	<div class="row">
            	...
            	<div class="col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-0 mar-60  text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mar-20">
                        	<h1 class="no-mar"><i class="fa fa-pencil"></i></h1>
                        	<h5>Click to start Online Registration for Delegates</h5>
                             <a href="online_reg_start.php" class="btn btn-primary btn-block">Start !</a>
                        </div>
                        <div class="col-sm-4 mar-20">
                        </div>
                    </div>
