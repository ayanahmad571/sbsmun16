        ...
        <div class="row">
          <div class="col-sm-6">
            <div class=" image-container embed-responsive embed-responsive-16by9">
              <img src="include/images/school_bg.jpg" />
            </div>
          </div>
          <div class="col-sm-6">
            ...
            <p> The Step by Step school is a well ordered, caring community in which relationships are based on mutual respect, and rules are applied consistently and fairly.</p><p>
We value the pursuit of academic excellence, the achievement of the individuals’ potential and contributions made to the life of the wider community.</p><p>
We encourage our children to develop self-discipline and respect and value the achievements, values and beliefs of others. We help our children to understand themselves and others, and to seek significance and purpose in all their experiences.</p><p>
Our values are reflected in all our policies and in the attitudes and conduct of our staff.
            </p>
            
            

          
            <p><a href="http://sbs-school.org" class="btn btn-primary">Visit the site</a></p>
          </div>
        </div>
      </div>
    </div>
