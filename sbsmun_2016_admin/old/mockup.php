...
<form action="master_action.php" method="post">
						<input type="hidden" value="'.md5(md5(sha1(md5($productrw['mock_id'])))).'" name="checker" />
...
<div class="form-group ">
    <div class="col-sm-3">
	    <input class="form-control" name="mk_pers_nm" type="text" placeholder="Person's Name">
    </div>
</div>
<div class="form-group ">
    <div class="col-sm-3">
	    <input class="form-control" name="mk_conct_no" type="number" placeholder="Phone No.">
    </div>
</div>
</div>
<div class="row">
...
<div class="form-group ">
    <div class="col-sm-11"><br>
	    ...
	    <input class="form-control" name="mk_pers_add" type="text" placeholder="Address">
    </div>
</div>
<div class="form-group ">
    <div class="col-sm-1">
	    <input class="form-control" name="mk_g_qty" value="1" type="number" placeholder="QTY">
    </div>
</div>
