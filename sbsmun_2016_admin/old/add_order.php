                        ...
                        <div class="row">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Add Orders</h3>
                                            ...
                                            <form action="../../sbsmun_2016_admin/old/sub_action_add.php" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Order Invoice Name</th>
                                                    <th>Buyer Name</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                            	<td><input class="form-control col-sm-12" name="or_ref_name" type="text"></td>
                                                <td><input class="form-control col-sm-12" name="or_buy_name" type="text"></td>
                                            </tr>
...
<div class="row">
  <div class="col-sm-3">
    ...
    <div class="form-group ">
      <div class="col-sm-12">
        <input id="or_pr_spcl" value="-" class="or_pr_spcl form-control" type="text" name="or_pr_spcl" />
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-3">
    <div class="form-group ">
      <div class="col-sm-12">
        <input id="or_pr_qty " class="or_pr_qty form-control" type="number" name="or_pr_qty"  />
      </div>
    </div>
  </div>
  <div class="col-sm-3">
    <div class="form-group ">
      <div class="col-sm-12">
        <input id="or_pr_ppp" class="or_pr_ppp form-control" type="number" name="or_pr_ppp" />
      </div>
    </div>
  </div>
</div>
...
<input style="display:none" value="1" id="o_or_ids_no " class="o_or_ids_no form-control" type="number" name="o_or_ids_no"  />
...
<div class="row">
    <div align="center" class="col-sm-4 col-sm-offset-4 ">
          <input type="submit" name="or_add" value="Submit Changes" class="btn btn-lg btn-success" >
    </div>
</div>   
                                    </div>
...
?>
     ...
     <script src="../../sbsmun_2016_admin/old/assets/clone/additional-methods.js"></script>

<script type="text/javascript"  src="../../sbsmun_2016_admin/old/assets/clone/clone-form-td.js"></script>
