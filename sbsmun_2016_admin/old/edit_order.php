...
<td class="or_pr_edit"  id="'.md5(md5(sha1(md5($products[$cv]['oi_id'])))).'_prorspcla">'.$products[$cv]['oi_pr_special'].'</td>
	...
	<input type="hidden" name="pr_or_delid" value="'.md5(sha1(md5(sha1(sha1(sha1($products[$cv]['oi_id'])))))).'" />
	<input type="submit" class="btn btn-danger" value="Delete" name="or_pr_del" />
	</form></td>
	';
	}
	echo '
...
<div id="add1" class="clonedInput">
  ...
  <div class="col-sm-3">
    ...
    <input name="content_or___d" type="hidden" value="<?php echo $or_id; ?>" />
  </div>
</div>
...
<div class="form-group ">
  <div class="col-sm-3">
    ...
    <input id="or_pr_spcl " class="or_pr_spcl form-control" type="text" name="or_pr_spcl"  />
  </div>
</div>
<div class="form-group ">
  <div class="col-sm-3">
...
<input style="display:none" value="1" id="or_ids_no " class="or_ids_no form-control" type="number" name="or_ids_no"  />
