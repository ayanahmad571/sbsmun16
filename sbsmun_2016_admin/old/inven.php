...
?>
        ...
        <script src="../../sbsmun_2016_admin/old/js/jasny-bootstrap.min.js"></script>
        <script src="../../sbsmun_2016_admin/old/js/ajax-upload.js"></script>
<script src="../../sbsmun_2016_admin/old/js/jquery.jeditable.ajax.js"></script>
<script src="../../sbsmun_2016_admin/old/js/jquery.lazyload.js"></script>
       <link href="../../sbsmun_2016_admin/old/css/jasny-bootstrap.min.css" rel="stylesheet">
...
if ($productres->num_rows > 0) {
	...
	<td >
		<img data-toggle="modal" data-target="#'.md5($productrw['pr_id'].$productrw['pr_img']).'" width="120px" data-original="'.$productrw['pr_img_2'].'" class="lazy img-responsive" />
...
<form action="master_action.php" method="post">
						<input type="hidden" value="'.md5(md5(sha1(md5($productrw['pr_id'])))).'" name="hchk" />
						<input type="submit" class="btn btn-danger"  name="pr_delete" value="Delete"/>
					</form>';echo '
				</td>';
         ...
         <div class="row">
            <div class="form-group ">
               <div class="col-sm-4"><br>
                  ...
                  <input class="form-control" name="pr_code" type="text" placeholder="Code">
               </div>
            </div>
            <div class="form-group ">
               <div class="col-sm-4">
                  <input class="form-control" name="pr_name" type="text" placeholder="Product Name">
               </div>
            </div>
            <div class="form-group ">
               <div class="col-sm-4">
                  <input class="form-control" name="pr_type" type="text" placeholder="Product Type">
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
            <div class="form-group ">
               <div class="col-sm-4"><br>
                  ...
                  <input class="form-control" name="pr_price" type="number" placeholder="Cost">
               </div>
            </div>
            <div class="form-group ">
               <div class="col-sm-4">
                  <select class="form-control" name="pr_per">
                     <option selected value="pc">Per Piece</option>
                     <option value="sqm">SquareMeter</option>
                  </select>
               </div>
            </div>
            <div class="form-group ">
               <div class="col-sm-4">
                  <input class="form-control" name="pr_qty" type="number" placeholder="Qty">
               </div>
            </div>
         </div>
         <div class="row">
